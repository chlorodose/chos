...
impl PageTable {
    pub const COUNT: usize = size_of::<Page>().exact_div(size_of::<AtomicUsize>());
    ...
    pub fn update_at(
        ...
        self.0[index]
            .fetch_update(Ordering::SeqCst, Ordering::SeqCst, |num| {
...
impl From<VirtPageNumber> for *mut Page {
    fn from(value: VirtPageNumber) -> Self {
        ptr::with_exposed_provenance_mut(value.0 * core::mem::size_of::<Page>())
    }
}
