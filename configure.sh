...
ln -sf ../bootloader/${BL}.ld configure/linker.ld
echo "include bootloader/${BL}.mk" >>configure/configure.mk

ln -sf ../arch/${ARCH}.json configure/target.json
ln -sf ${LIMINE_PATH}/BOOT${ARCH_UPPER}.EFI configure/BOOT${ARCH_UPPER}.EFI
